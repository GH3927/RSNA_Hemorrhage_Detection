...
def preprocess_dcm(*dicom_path, windowing, window_center, window_width, max_size=512, mean=(0.485, 0.456, 0.406), std=(0.229, 0.224, 0.225)):
    ori_imgs = []
    
    for dcm_path in dicom_path:
        # load dcm
        ...
        # windowing 수행
        img = windowing(img, window_center, window_width)        
